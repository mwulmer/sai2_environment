...
class RobotEnv(object):
    def __init__(self, name='move_object_to_target', 
                simulation=True, 
                render=False, 
    ...
    def step(self, action):
        assert action.shape == self._robot_action.action_space_size().shape, "Action shape not correct, see action_space.py "
        ...
        if self.env_config['blocking_action']:
            ...
            print("Waiting for robot: {}".format(self._client.action_complete()))
